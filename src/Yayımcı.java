...
public class Yayımcı extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Yayımcı İsmi", "Adres", "Telefon Numarası"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            try {  
            pst = (PreparedStatement) con.prepareStatement("insert into yayımcı(isim,adres,telefon)values(?,?,?)");
        ...
        // TODO add your handling code here:
         ...
         int id = Integer.parseInt(d1.getValueAt(selectIndex, 0).toString());
          ...
          String isim = txtisim.getText();
            ...
            try {  
            pst = (PreparedStatement) con.prepareStatement("update yayımcı set isim = ?, adres= ? , telefon = ? where id = ?");
            pst.setString(1,isim);
            pst.setString(2, adres);
            pst.setString(3, telefon);
             pst.setInt(4, id);
            ...
            if(k==1){
                JOptionPane.showMessageDialog(this,"Yayımcı Yenilendi");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {  
            pst = (PreparedStatement) con.prepareStatement("delete from yayımcı where id = ?");
